...
function munculbwh3() { kalimatbawah.innerHTML = kalimatbawah3.innerHTML; setTimeout(munculbwh4, 2000); otomatis(); }
function munculbwh4() { kalimatbawah.innerHTML = kalimatbawah4.innerHTML; setTimeout(munculbwh, 2000); otomatis(); }
function otomatis() { kalimatbawah.style = "position:relative;opacity:0;transform:scale(.4);"; setTimeout(anim, 300); }
